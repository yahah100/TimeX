...
for i in range(2, 6):
    ...
    trainEpi, val, test = process_MITECG(split_no = i, device = device, hard_split = False, base_path = '/n/data1/hms/dbmi/zitnik/lab/users/owq978/TimeSeriesCBM/datasets/MITECG-Simple/')
    ...
    spath = 'models/transformer_new_split={}.pt'.format(i)
    ...
    torch.save(model_sdict_cpu, 'models/transformer_new_split={}_cpu.pt'.format(i))
